...
function problemB() {
  ...
  const exerciseB = async () => {
    ...
    console.log("-- B. asyn/await version (stanza two) --");
    blue(stanza2);
    console.log("-- B. asyn/await version (stanza three) --");
    blue(stanza3);
  };
  exerciseB();
}
...
function problemD() {
  ...
  // AsyncAwait version
  const exerciseD = async () => {
    try {
      console.log('-- D. asyn/await version (stanza four) --');
...
function problemE() {
  ...
  // AsyncAwait version
  const exerciseE = async () => {
    try {
      console.log('-- E. async/await version (stanza three) --');
      const stanza3 = await promisifiedReadFile('poem-one/stanza-03.txt');
      blue(stanza3);
    } catch(e) {
      magenta(e);
    ...
    try {
      console.log('-- E. async/await version (stanza four) --');
      const stanza4 = await promisifiedReadFile('poem-one/stanza-04.txt');
      blue(stanza4);
    } catch(e) {
      magenta(e);
...
function problemF() {
  ...
  // AsyncAwait version
  const exerciseF = async () => {
    try {
      console.log('-- F. async/await version (stanza three) --');
      const stanza3 = await promisifiedReadFile('poem-one/stanza-03.txt');
      blue(stanza3);
    } catch(e) {
      magenta(e);
    ...
    try {
      console.log('-- F. async/await version (stanza four) --');
      const stanza4 = await promisifiedReadFile('poem-one/stanza-04.txt');
      blue(stanza4);
    } catch(e) {
      magenta(e);
    }
    console.log('-- F. async/await version done --');
  };
  exerciseF();
}
